...
<section id="z`z`">
		...
		<h2 class="title text-center">User <strong>List</strong></h2> 
				<table class="table table-condensed">
					...
					<tbody>
					<!-- loop_start -->
					<sql:setDataSource var="myDs" driver="com.microsoft.sqlserver.jdbc.SQLServerDriver" url="jdbc:sqlserver://localhost;databaseName=userdb" user="huanghao" password="123456" />
