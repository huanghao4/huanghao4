			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<!-- loop_start -->
						...
						<td>order Date</td>
						<%
							com.huanghao.model.Order o=(com.huanghao.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.huanghao.dao.UserDao userDao=new com.huanghao.dao.UserDao();
						...
						<%
							...
							String paymentType=com.huanghao.model.Payment.findByPaymentId(con,n);
							 %>
