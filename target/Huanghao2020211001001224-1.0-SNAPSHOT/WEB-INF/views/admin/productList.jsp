					...
					<c:forEach var="p" items="${productList}">
						<tr>
							...
							<%
								...
								com.huanghao.model.Product p=(com.huanghao.model.Product) pageContext.findAttribute("p");
								int pid=p.getCategoryId();
								java.sql.Connection con=(java.sql.Connection) application.getAttribute("con");
								String catName=com.huanghao.model.Category.FindByCategoryId(con,pid);
							%>
